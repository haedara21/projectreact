...
export default function CardPersons(props) {
   ...
   return (
    <Flex key={props.key} onMouseOver={() =>{setShadow("block")}} onMouseLeave={() =>{setShadow('none')}} className={"CardPer personCards"} width={"450px"} display={"flex"} flexDirection={"column"} gap={"20px"}>
